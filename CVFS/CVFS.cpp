...
{ 
	...
	{ 
		...
		{ 
			...
			else if(strcmp(command[0],"usage") == 0)
			{
    			CommandInfo();
    			continue;
			}
...
void CommandInfo()
{
    ...
    printf("\n1) creat <FileName> <Permission>");
    printf("\n   Permission : 1(Read)  2(Write)  3(Read+Write)");
    printf("\n   Example    : creat demo 3\n");

    printf("\n2) open <FileName> <Mode>");
    printf("\n   Mode : 1(Read)  2(Write)  3(Read+Write)");
    printf("\n   Example : open demo 1\n");

    printf("\n3) read <FileName> <No_of_Bytes>");
    printf("\n   Example : read demo 100\n");

    printf("\n4) write <FileName>");
    printf("\n   After command, enter data manually");
    printf("\n   Example : write demo\n");
    ...
    printf("\n10) truncate <FileName>");
    printf("\n    Example : truncate demo\n");

    printf("\n11) rm <FileName>");
    printf("\n    Example : rm demo\n");

    printf("\n12) lseek <FileName> <Offset> <StartPoint>");
    printf("\n    StartPoint : 0(START)  1(CURRENT)  2(END)");
    printf("\n    Example : lseek demo 10 0\n");
...
{ 
	...
	printf("\n\t Usage   : It is used to display how to write and use all file operation commands properly.");
